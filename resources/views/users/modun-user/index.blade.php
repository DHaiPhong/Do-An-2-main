       ...
       <a href="{{ route('users.productdetail', $rate->slug) }}" class="img-wrap" data-abc="true"> <img src="anh/{{$rate->prd_image}}"> </a>
         <figcaption class="info-wrap">
             ...
             <div class="col-md-3 col-xs-3">
                     <div class="rating text-right" style="text-wrap:nowrap"> @for($i = 0 ;$i < round($rate->average_rating, 0, PHP_ROUND_HALF_UP); $i++)  <i class="fa fa-star"></i> @endfor  </div>
                 <span class="rated" style="font-size:15px; text-wrap:nowrap">Rated {{round($rate->average_rating,0)}}/5</span>
                </div> 
         </figcaption>
