        ...
        @endif
                <form method="post" id="myform" action="">
                    ...
                    <div class="row" style="font-size: 17px;">
                        <h3 style="font-size:22px; margin-bottom:0; text-align:center" class="title">NHẬP THÔNG TIN GIAO HÀNG</h3>
                        <div class="col">
                            <div class="inputBox">
                                <span>Họ và tên :</span>
                                <input name="name" type="text" value="{{ Auth::user()->name }}" required placeholder="">
                            </div>
                            <div class="inputBox">
                                <span>email :</span>
                                <input name="email" type="email" value="{{ Auth::user()->email }}" required placeholder="">
                            </div>
                            <div class="inputBox">
                                <span>Thành phố :</span>
                        ...
                        <div class="col">
                            ...
                            <div class="inputBox">
                                ...
                                <input name="address" type="text" value="{{ Auth::user()->address }}" required placeholder="">
                            </div>
                            <div class="inputBox">
                                <span>Số điện thoại :</span>
                                <input name="phone" id="phone_number" type="text" value="{{ Auth::user()->phone }}" required placeholder="">
                            </div>
                            <div class="inputBox">
                    ...
                    <div class="row" style="flex-wrap:nowrap">
                        ...
                        <div class="col-md-6" style="width: 49%;">
                            <button type="button" id="btnOnline" class="submit-btn momo" name="payUrl">MOMO<br>(Thanh toán Online)</button>
