                ...
                <div class="right-col">
                    ...
                    <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                        ...
                        <form method="post" action="{{route('cart.add')}}">
                            ...
                            <div class="btn-and-quantity-wrap" style="display: inline-block;margin-top: 1rem;border-radius: .5rem;border: .2rem solid #000;font-weight: bolder;font-size: 1.7rem;
                                color: #000;
                                cursor: pointer;
                                background: #fff;
                                padding: .8rem 3rem;">
        ...
        <table  class="table1">
            <tr>
                ...
                <td class="text-column1">
                    ...
                    <p>Products are always tested and evaluated by VNSneakers with the highest quality before reaching customers!</p>
                </td>
            </tr>
            <tr>
                ...
                <td class="text-column1">
                    <h2>Delivery time?</h2>
                    <p>We use the most reputable and fastest shipping unit, the estimated time is from 1-4 days depending on the area.</p>
                </td>
            </tr>
            <tr>
                ...
                <td class="text-column1">
                    ...
                    <p>Due to some objective factors such as screen brightness, screen quality, the product may not be the right color.</p>
                </td>
            </tr>
            <tr>
        ...
        <table  class="table1">
            ...
            <tr>
                ...
                <td class="text-column1">
                    ...
                    <p>Exchanges are easy and we always want our customers to be satisfied. Please contact fanpage to change!</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-column1">
                    ...
                    <p>You can go to the store or send it back for an exchange with a 100% new product. Still have tags and purchase receipt.</p>
                </td>
            </tr>
        </table>
    </div>
