                                                ...
                                                <form id="editForm" method="post" action="{{ route('resetpassword') }}">
                                                    ...
                                                    <div style="display:flex; flex-wrap:nowrap;">
                                                        ...
                                                        <div class="right-form" style="flex:80%;">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="password" class="form-control"
                                                                    style="font-size:16px;" value="" required
                                                                    name="password" />
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="submit" id="btn" class="btn btn-primary"> Save
                                                        </button>
                                                    </div>
                                                </form>
                                ...
                                <div class="col-lg-10" style="width:100%">
                                    <div class="card" style="border-radius: 10px;">
                                            ...
                                            <div class="card-body" style="padding:3px;">
                                                <div class="row" style="font-size:15px">
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="  mb-0" style="font-size:15px;text-wrap: nowrap;">Người
                                                            đặt</p>
                                                    </div>
                                                    <div
                                        ...
                                        @foreach ($orders as $key => $item)
                                            <div class="card shadow-0 border mb-4">
                                                <div class="card-body"
                                                    style="padding:3px;border-top:2px solid #57555585;">
                                                    <div class="row" style="font-size:15px">
                                                        ...
                                                        <div
                                                            class="col-md-1 text-center d-flex justify-content-center align-items-center">
                                                            <p class="  mb-0" style="font-size:15px;text-wrap: nowrap;">
                                                                {{ $item->name }}
                                                            </p>
                                                        </div>
                                                        <div
                                                            class="col-md-4 text-center d-flex justify-content-center align-items-center">
                                                            <p class="  mb-0 small" style="font-size:15px;">
                                                                {{ $item->address }}</p>
                                                        </div>
                                                        <div
                                                            class="col-md-1 text-center d-flex justify-content-center align-items-center">
                                                        ...
                                                        <div
                                                            class="col-md-1 text-center d-flex justify-content-center align-items-center">
                                                            <p class="  mb-0 small"
                                                                style="font-size:15px;text-wrap: nowrap;">
                                                        ...
                                                        <div class="row d-flex align-items-center justify-content-between">
                                                            <div class="col-md-1 mr-auto">
                                                                <p class="  mb-0 small"
                                                                    style="font-size:15px;text-wrap: nowrap;">Tiến trình
                                                                </p>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <div class="progress"
                                                                ...
                                                                <div class="d-flex mb-1 justify-content-end">
                                                                    @if ($item->status == 'cancel')
                                                                        <p class="" style="font-size:15px">Đơn hàng
                                                                            đã bị hủy</p>
                                                                    @elseif($item->status == 'pending')
