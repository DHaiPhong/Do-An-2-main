        ...
        <div class="card" style="float: right; width: 80%">
            <div class="card-body">
                ...
                @elseif($order->status == 'pending')
                    <a class="btn btn-info btn-fw"
                        href="{{ route('admin.updatestatus', ['id' => $order->order_id, 'processing']) }}"> Processing </a>
                @elseif($order->status == 'processing')
                    <a class="btn btn-success btn-fw"
                        href="{{ route('admin.updatestatus', ['id' => $order->order_id, 'completed']) }}"> Completed </a>
